# [Jinja Template - Atlantis Dark](https://appseed.us/jinja-template/jinja-template-atlantis-dark)

> Seed project coded in Flask/Jinja on top of Pixel UI KIt (free version) - Features:

- UI Kit: **Atlantis Dark** (Free Version) by **ThemeKita**
...
- [Jinja Template Pixel Demo](https://jinja-template-atlantis-dark.appseed.us/) - LIVE Demo
- [Jinja Template](https://appseed.us/jinja-template) - A curated list with Jinja Templates (free & commercial) generated by AppSeed

<br />

## UI Kit - [Atlantis Dark](https://themekita.com/demo-atlantis-lite-bootstrap/?ref=appseed)

*Vendor Notes* - Free Bootstrap Admin Template, Full responsive design based on Bootstrap, Background Color Variations Layout, 100+ UI Components, Easy to customize.
