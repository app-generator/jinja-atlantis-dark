# [Jinja Atlantis Dark](https://appseed.us/jinja-template/jinja-template-atlantis-dark)

**Jinja Template** project generated by AppSeed on top of a modern UI Kit - **Atlantis Lite** (DARK Layout).  The project is a super simple Flask project WITHOUT database, ORM, or any other hard dependency. The project can be used as a codebase for future project or to migrate the Jinja files and assets to a legacy Python-based project that uses Jinja as template engine (Flask, Bottle, Django).
...
- [Jinja Atlantis Dark](https://jinja-atlantis-dark.appseed-srv1.com/) - LIVE Demo
- [Jinja Atlantis Dark](https://docs.appseed.us/products/jinja-templates/atlantis-lite) - product documentation
...
---
Jinja Atlantis Dark - Provided by **AppSeed** [App Generator](https://appseed.us/app-generator).
